...
mkdir -p "$output_directory/small4"

#for ((i = 1; i <= file_count; i++));
#for file_num in {1..62500}
for file_num in $(seq 180001 240000)
do
	...
	dd if=/dev/urandom of="$output_directory/small4/$file_name" bs=1 count="$file_size" status=none
