...
enum NvmeAdminCommands {
    ...
    NVME_ADM_HPB_READ_SEGMENT     = 0x83,
    NVME_ADM_HPB_TRANSFER_SEGMENT = 0x84,
    NVME_ADM_HPB_MULTI_L2P_ENTRY  = 0x85,
    NVME_ADM_HPB_WRITE_SEGMENT    = 0x86,
    NVME_ADM_HPB_TRANSFER_VPB     = 0x87,
...
enum NvmeIoCommands {
    ...
    NVME_CMD_HPB_READ             = 0x83,
    NVME_CMD_HPB_TRANSFER_SEGMENT = 0x84,
    NVME_CMD_HPB_MULTI_L2P_ENTRY  = 0x85,
    NVME_CMD_HPB_WRITE_SEGMENT    = 0x86,
    NVME_CMD_HPB_TRANSFER_VPB     = 0x87,
...
#define NVME_HPB_ENABLE                        1
#define NVME_HPB_PLUS_ENABLE                   2
#define TOTAL_CACHE_SEGMENT                    (30720)
//#define TOTAL_CACHE_SEGMENT                    (10240)
// 2560: 10MB, 5120: 20MB, 10240: 40MB, 20480: 80MB, 32768: 128MB

enum NvmeHpbEventRequest {
    NVME_INVLIAD_SEGMENT                    = 0,
    NVME_READ_L2P_SEGMENT                   = 1,
    NVME_WRITE_L2P_SEGMENT                  = 2,
    NVME_UPDATE_L2P_ENTRY            	    = 3,
    NVME_UPDATE_MULTI_L2P_ENTRY             = 4,
    NVME_UPDATE_MULTI_L2P_ENTRY_COMPLETE    = 5,
    NVME_TRNSFER_VALID_PAGE_BITMAP_PER_BLK  = 6,
};
...
typedef struct NvmeCqe {
    ...
    uint8_t     type;
    uint8_t     length;
    uint16_t    segment_idx_or_src_blk;
    uint32_t    lpn;
    uint32_t    ppn;
...
static inline void nvme_check_size(void)
{
    ...
    QEMU_BUILD_BUG_ON(sizeof(NvmeCqe) != 32);
...
typedef struct NvmeRequest {
    ...
    uint32_t                ppa;
    uint32_t                key;
    uint32_t                complete_sequence_number;
    uint32_t                map_read;
    uint32_t                init;
    uint16_t                ctrl;
    uint64_t                meta_size;
